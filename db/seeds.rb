...
crossfit_photo = File.open(Rails.root.join('app/assets/images/crossfit.png'))
...
puts "got here"
activity1.photo.attach(io: File.open(Rails.root.join('app/assets/images/crossfit.png')), filename: 'crossfit.png', content_type: 'image/png')
activity1.save!
...
# activity12.photo.attach(io: File.open("app/assets/images/aerobic_classes.png"), filename: "attachment_12", content_type: "image.png")
...
# activity21.photo.attach(io: File.open("app/assets/images/gym_session.png"), filename: "attachment_21", content_type: "image.png")
